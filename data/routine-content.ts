...
export const BEDTIME_ROUTINE_ITEMS: Record<RoutineTier, RoutineItem[]> = {
  ...
  1: [
    ...
    { id: "b1-7", label: "Wash face", category: "Body + comfort" },
    { id: "b1-8", label: "Use lotion and minoxidil", category: "Body + comfort" },
    { id: "b1-9", label: "Teeth (brush/floss)", category: "Body + comfort" },
    { id: "b1-10", label: "Pimple patch if needed", category: "Body + comfort" },
    { id: "b1-11", label: "Set pillow/nest, weighted blanket, squish", category: "Body + comfort" },
    { id: "b1-12", label: "Write goals for tomorrow (1–3 items max)", category: "Close loops" },
    { id: "b1-13", label: "Write worries down (container + revisit time)", category: "Close loops" },
    { id: "b1-14", label: "Downshift: body scan OR 4 exhales OR grounding OR kind sentence", category: "In bed" },
  ],
  2: [
